    ...
    <div class="fieldset">
        <div class="container-fluid">
            ...
            $items = [
                ...
                [
                    'label' => 'ALISPLY MUROS',
                    'content' => $this->render('/guia/elementos2', ['id' => 1]),
