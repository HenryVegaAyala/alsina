...
class FacGuiaDetal extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['FAC_COD_GUIA', 'COD_CATG', 'COD_MAE_PRODU', 'UD'], 'integer'],
            [['PREC_X_DIA', 'PESO_REAL', 'PESO_VOL', 'PESO_REAL_TOTAL', 'CANT_DIAS', 'COST_TOTAL', 'PESO_V_TOTAL'], 'number'],
            [['FECH_DIGI', 'FECH_MODI', 'FECH_ELIM'], 'safe'],
            [['NUM_PROD', 'DESC_CORTAR', 'USU_DIGI', 'USU_MODI', 'USU_ELI', 'COD_ESTA'], 'string', 'max' => 45],
            [['DESC_LARGA'], 'string', 'max' => 100],
            [['FAC_COD_GUIA'], 'exist', 'skipOnError' => true, 'targetClass' => Guia::className(), 'targetAttribute' => ['FAC_COD_GUIA' => 'COD_GUIA']],
